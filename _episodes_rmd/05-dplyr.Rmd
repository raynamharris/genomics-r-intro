---
title: "Data Wrangling and Organization with the Tidyverse"
teaching: 40
exercises: 15
questions: How can I manipulate data frames effeciently and reproducibly?
objectives:
...
```{r, include = TRUE, echo = T, eval = TRUE, purl = FALSE, message = F, warning = F}
# read data
library(readr)
...
<center>
<img src="https://d33wubrfki0l68.cloudfront.net/621a9c8c5d7b47c4b6d72e8f01f28d14310e8370/193fc/css/images/hex/dplyr.png" style="width: 200px;"/>
</center>
...
Let's install (if necessary) and load the `dplyr` package.
...
* [Data import with readr, readxl, and googlesheets4 cheatsheet](https://github.com/rstudio/cheatsheets/blob/main/data-import.pdf)
* [Data transformation with dplyr cheatsheet](https://github.com/rstudio/cheatsheets/blob/main/data-transformation.pdf)
* [Data tidying with tidyr cheatsheet](https://github.com/rstudio/cheatsheets/blob/main/tidyr.pdf)
